...
class SubscribersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscriber" do
    assert_difference('Subscriber.count') do
      post subscribers_url, params: { subscriber: { plan_name: @subscriber.plan_name, validity: @subscriber.validity } }
    end
  ...
  test "should update subscriber" do
    patch subscriber_url(@subscriber), params: { subscriber: { plan_name: @subscriber.plan_name, validity: @subscriber.validity } }
